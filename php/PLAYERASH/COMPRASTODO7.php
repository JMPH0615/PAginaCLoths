        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://milano.com/cdn/shop/products/661-9025A_Playera_Basica_Lisa_Manga_Corta_Cuello_Redondo_Caballero_Milano_Tallas-Extras_e_250x.jpg?v=1664405148" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera hombre roja   </h1>
                        <div class="fs-5 mb-5">
...
¡Despierta tu estilo con nuestra vibrante playera roja para hombre! Esta prenda es una elección audaz y versátil que te permite destacar con confianza en cualquier ocasión.

Confeccionada en algodón de alta calidad, esta playera ofrece comodidad y suavidad, convirtiéndola en una opción ideal para tu día a día. El color rojo intenso agrega un toque de energía y vitalidad a tu vestuario, haciéndote destacar con estilo.</p>
                        <div class="d-flex"> 
            ...
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="https://oranch.com.mx/wp-content/uploads/2021/06/sublimados_0028_Captura-de-Pantalla-2021-06-08-a-las-13.34.08.jpg" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder"> Playera hombre negra</h5>
                                <!-- Product price-->
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRATODO3.php">VER DETALLES</a></div>
                        </div>
                    </div>
                </div>
                <div class="col mb-5">
                ...
                <div class="col mb-5">
                    <div class="card h-100">
                        ...
                        <!-- Product image-->
                        <img class="card-img-top" src="https://tienda.suministrosag.mx/data/images/products/1668114596-playerablancaoptima-min.jpg" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                        ...
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRATODO5.php"> VER DETALLES </a></div>
                        </div>
                    </div>
                </div>
                <div class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="https://plash.mx/cdn/shop/products/Feliz_Navidad_Playera_para_Caballero.jpg?v=1590858745" alt="..." />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h5 class="fw-bolder"> Playera Caballero Feliz Navidad </h5>
                                <!-- Product reviews-->
                                <div class="d-flex justify-content-center small text-warning mb-2">
                                    <div class="bi-star-fill"></div>
                                    <div class="bi-star-fill"></div>
                        ...
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRATODO6.php"> VER DETALLES </a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera hombre roja   '; // Reemplaza con la información del producto
                var precio = 210; // Reemplaza con el precio del producto
