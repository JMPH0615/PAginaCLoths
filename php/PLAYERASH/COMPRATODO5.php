            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="../../php/PRINCIPALPLAYERAS.php">INICIO</a></li>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://tienda.suministrosag.mx/data/images/products/1668114596-playerablancaoptima-min.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera Hombre Blanca   </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 149</span>
                        </div>
                        <p class="lead">
                            Eleva tu estilo con nuestra clásica playera blanca para hombre, una prenda esencial que combina simplicidad y versatilidad con un toque de elegancia atemporal.

Confeccionada en algodón de alta calidad, esta playera proporciona comodidad durante todo el día y se adapta perfectamente a cualquier temporada. Su diseño limpio y minimalista la convierte en una pieza básica que es fácil de combinar con una variedad de estilos y atuendos.</p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcSCTDEoOp59WCllTt2uftH92BXPGGwRfyeCnpCdUP1tITHs36oYPmBlUtNgT5pt72jcuj2eNzLI0KA6RGm4Mp6_XuO_maYfJhKplPlajOf_SJF0u2Qi_jD7gg&usqp=CAE" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">   Playera Harry Potter Cuello Redondo talla G  </h5>
                                    <!-- Product price-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRASTODO1.php">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://www.stkmcompany.com/cdn/shop/files/playeras_1080x1080_Anime1_JaspeRojo-negro_74d9061e-bdbd-44c8-8cc1-74cb206196f5.jpg?v=1682393843" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Playera hombre Anime Bubble Tea Manga Larga </h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRASTODO9.php"> VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://ayapromotions.mx/wp-content/uploads/2021/03/playera-pc-cr-mc-joven-100algodon-jade_1.png" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Playera Cuello redondo verde </h5>
                                    <!-- Product price-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRATODO4.php"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://suavecito.com.mx/cdn/shop/products/Suavecito_Mexican_Flag_OG_Tee_Front_2048x_395529be-b8a8-4bd3-83eb-3ffaed34850d.jpg?v=1598484328" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Playera hombre OG banda de México </h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRATODO11.php"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera blanca hombre   '; // Reemplaza con la información del producto
                var precio = 149; // Reemplaza con el precio del producto
