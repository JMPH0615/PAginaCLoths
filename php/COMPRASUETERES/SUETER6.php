...
<html lang="en">
    <head>
        ...
        <title>  Gibobby Suéter para hombre Suéteres para hombres, cuello redondo</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSz5UBP3k2--B9vNGNXp0ISZoJGS37xS6m82w&usqp=CAU" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Gibobby Suéter para hombre Suéteres para hombres, cuello redondo</h1>
                        <div class="fs-5 mb-5">
                           
                            <span>MXN 649</span>
                        </div>
                        <p class="lead">Actualiza tu guardarropa de invierno con el elegante y cómodo suéter para hombre de Gibobby. Este suéter clásico presenta un diseño atemporal con cuello redondo, ideal para mantenerte abrigado con estilo durante los días más fríos.</p>
                        <div class="d-flex"> 
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"> Chaqueta De Suéter De Lana Con Cremallera Delgada Para Suéter Hombre </h5>
                                    <!-- Product price-->
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Gibobby Suéter para hombre Suéteres para hombres'; // Reemplaza con la información del producto
                var precio = 649; // Reemplaza con el precio del producto
