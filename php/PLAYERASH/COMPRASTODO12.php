...
<html lang="en">
    <head>
        ...
        <title>   Playera Under Armour Project Rock  </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://www.innovasport.com/medias/playera-under-armour-project-rock-is-1351582-001-1.png?context=bWFzdGVyfGltYWdlc3w1OTg4N3xpbWFnZS9wbmd8aW1hZ2VzL2hiOC9oNDAvOTkxMDUxMjI4Nzc3NC5wbmd8NWIzNWJhOGUxYTdjMTU5OTgwNzFlM2M1YWExNTdkOGRkM2Y0NGJkYTMxZGRjYjJkNDNhYWMwNzk3NDI1MGFjMg" alt="..." /></div>
                    <div class="col-md-6">
                       
                        <h1 class="display-5 fw-bolder">  Playera Under Armour Project Rock  </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 459</span>
                        </div>
                        <p class="lead">
                        ¡Alcanza nuevos niveles de rendimiento y estilo con la Playera Under Armour Project Rock! Diseñada en colaboración con el famoso atleta Dwayne "The Rock" Johnson, esta playera te brinda la combinación perfecta de comodidad, estilo y motivación.</p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.etsystatic.com/31591741/r/il/aece3a/3565054567/il_1080xN.3565054567_5cvy.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Playera hombre kawai </h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRATODO10.php"> VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Playera hombre Harry potter </h5>
                                    <!-- Product price-->
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = '  Playera Under Armour Project Rock '; // Reemplaza con la información del producto
                var precio = 459; // Reemplaza con el precio del producto
