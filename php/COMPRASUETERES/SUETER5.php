...
<html lang="en">
    <head>
        ...
        <title>  Suéter Casual de Los Hombres Suéter</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://cdn-images.farfetch-contents.com/21/50/74/57/21507457_51537086_300.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">   Suéteres de diseñador - Moda para hombre</h1>
                        <div class="fs-5 mb-5">
                            MXN 549
                        </div>
                        <p class="lead">¡Descubre la sofisticación y el estilo excepcional con nuestra exclusiva colección de Suéteres de Diseñador para Hombre! Creados por reconocidos diseñadores de moda, estos suéteres representan la vanguardia en términos de elegancia y calidad. </p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://image.made-in-china.com/202f0j00gqobsGKcnikp/Custom-Make-Knit-Jacquard-Plus-Size-Men-s-Sweaters-Cotton-Cashmere-Pullover-Knitted-Wool-Crewneck-Men-Sweater.webp" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Custom Make Knit Jacquard Plus Size Suéter de algodón cashmere para hombre Jersey </h5>
                                    <!-- Product price-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="SUETER12.PHP">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://static.pullandbear.net/2/photos/2023/I/0/2/p/7555/515/251/7555515251_1_1_3.jpg?t=1698241212825" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">   Suéter de rayas hombre</h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="SUETER11.PHP"> VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://www.skannda.mx/cdn/shop/products/SUETERCASUALTEJIDOLIGERO.jpg?v=1622312843" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Suéter Hombre Tejido De Punto Cuello Alto</h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="SUETER7.PHP"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Suéteres de diseñador'; // Reemplaza con la información del producto
