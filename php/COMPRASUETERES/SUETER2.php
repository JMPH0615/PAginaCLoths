...
<html lang="en">
    <head>
        ...
        <title> Suéter Casual Para Mantener El Calor </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://m.media-amazon.com/images/I/71YjmWc7L2L._AC_UF894,1000_QL80_.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Suéter Casual Para Mantener El Calor Suéter de color liso for hombre de otoño e invierno</h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 649</span>
                        </div>
                        <p class="lead">
                            ¡Bienvenido a la elección perfecta para mantener el calor con estilo durante las estaciones más frías! Presentamos nuestro "Suéter Casual para Mantener el Calor", diseñado para brindarte comodidad y elegancia durante el otoño e invierno.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Suéter Casual Para Mantener El Calor'; // Reemplaza con la información del producto
