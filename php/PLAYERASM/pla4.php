...
<html lang="en">
    <head>
        ...
        <title>  Playera California Gris con Negro Manga Corta</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/564x/33/e2/3b/33e23b0f6903bd1267ddadf13a9955e3.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera California Gris con Negro Manga Corta</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 249</span>
                            <span>MXN 199</span>
                        </div>
                        <p class="lead">Una playera en tonos grises con negro de manga corta con un estampado de CALIFORNIA.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Playera California Gris'; // Reemplaza con la información del producto
