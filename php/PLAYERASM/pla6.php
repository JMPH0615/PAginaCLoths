...
<html lang="en">
    <head>
        ...
        <title>  Playera Florida Color Negro Con Beige</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/97/c9/2b/97c92b00be50c495c208e00a5d81f94f.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera Florida Color Negro Con Beige</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 249</span>
                        </div>
                        <p class="lead">Una prenda de vestir informal que combina dos tonos: negro y beige. La parte principal de la playera, es un estampado con las letras de florida y su llamativo partido de colores.</p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.pinimg.com/236x/54/11/bc/5411bca5b05fb5dfa5a4e57ba9361495.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Playera corta color blanco con negro'; // Reemplaza con la información del producto
                var precio = 199; // Reemplaza con el precio del producto
