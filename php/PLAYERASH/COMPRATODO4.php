...
<html lang="en">
    <head>
        ...
        <title>   Playera Cuello redondo verde   </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://ayapromotions.mx/wp-content/uploads/2021/03/playera-pc-cr-mc-joven-100algodon-jade_1.png" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera Cuello redondo verde  </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 229</span>
                        </div>
                        <p class="lead">
                            ¡Haz una declaración de estilo fresco con nuestra playera de cuello redondo en un vibrante color verde! Esta prenda no solo te brinda comodidad, sino que también inyecta un toque de energía y vitalidad a tu vestuario.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera Cuello redondo verde  '; // Reemplaza con la información del producto
                var precio = 229; // Reemplaza con el precio del producto
