...
<html lang="en">
    <head>
        ...
        <title>  Top negro con tirantes</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/50/d5/9d/50d59d9e13e79410e2261b9b32ebe830.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top negro con tirantes</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 349</span>
                            <span>MXN 329</span>
                        </div>
                        <p class="lead"> Top blanco con escote y mangas medias estilo moderno.</p>
                        <div class="d-flex"> 
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">    Top negro tipo corssette en forma de V con tirantes delgados</h5>
                                    <!-- Product reviews-->
