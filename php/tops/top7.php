...
<html lang="en">
    <head>
        ...
        <title>  Top verde floreado</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/564x/cf/b9/50/cfb95023c8c3c5b7d7f1be33ac9e2a32.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top verde floreado</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 199</span>
                        </div>
                        <p class="lead"> Top verde con mangas cortas escote en V, botones delanteros y estampado de flores. </p>
                        <div class="d-flex"> 
