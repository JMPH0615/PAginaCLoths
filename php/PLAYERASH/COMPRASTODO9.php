...
<html lang="en">
    <head>
        ...
        <title>     Playera hombre Anime   </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://www.stkmcompany.com/cdn/shop/files/playeras_1080x1080_Anime1_JaspeRojo-negro_74d9061e-bdbd-44c8-8cc1-74cb206196f5.jpg?v=1682393843" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">    Playera hombre Anime Bubble Tea Manga Larga    </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 399 </span>
                        </div>
                        <p class="lead">
                            ¡Sumérgete en el mundo del anime con nuestra exclusiva playera de manga larga "Bubble Tea" para hombre! Esta prenda única fusiona la pasión por el anime con el encanto del bubble tea, creando un estilo distintivo que no pasará desapercibido.</p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRASTODO5.php"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera tirando rostro  '; // Reemplaza con la información del producto
