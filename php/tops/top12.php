...
<html lang="en">
    <head>
        ...
        <title>  Top manga larga color blanco </title>
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" 
                        src="https://i.pinimg.com/236x/f0/48/cb/f048cb5dfb142a21873568a27d67446d.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top manga larga color blanco </h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 299</span>
                        </div>
                        <p class="lead"> Top blanco con escode en V y mangas largas. </p>
                        <div class="d-flex"> 
