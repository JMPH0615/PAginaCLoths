...
<html lang="en">
    <head>
        ...
        <title>  Playera Brooklyn Color Negro Manga Corta</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/62/af/1d/62af1d77b96a58486c5a91cb67b0fad6.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera Brooklyn Color Negro Manga Corta</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 499</span>
                            <span>MXN 399</span>
                        </div>
                        <p class="lead">Una playera corta color negro con estampado en letras rojas de Brooklyn</p>
                        <div class="d-flex"> 
            ...
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.pinimg.com/236x/97/c9/2b/97c92b00be50c495c208e00a5d81f94f.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Playera Florida Color Negro Con Beige</h5>
                                    <!-- Product reviews-->
                                    <!-- Product reviews-->
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Playera Brooklyn Color Negro'; // Reemplaza con la información del producto
