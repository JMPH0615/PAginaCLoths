            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="../TOPS.php">INICIO</a></li>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/bb/60/08/bb6008242a5878ad118f71a06f6c21ce.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top color rosa</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 299</span>
                            <span>MXN 249</span>
                        </div>
                        <p class="lead"> Top arriba del ombligo de color rosa con cuadros blancos, tirantes gruesos y un listos en la parte de la espalda.  </p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.pinimg.com/236x/a4/2f/b9/a42fb9daa7f893e691b7ad71955d19d8.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"> Top color negro con blanco y mariposas </h5>
                                    <!-- Product reviews-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="pla2.html">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.pinimg.com/236x/dc/e9/98/dce99870f69a9acfdb267ff45375061b.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Top negro con tirantes de cadenas</h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="pla3.html"> VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.pinimg.com/564x/e5/ce/d7/e5ced7a2b9ba790f60fa832a444f309f.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">    Top blanco con mangas</h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="quintacompra.html"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.pinimg.com/236x/50/d5/9d/50d59d9e13e79410e2261b9b32ebe830.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Top negro con tirantes</h5>
                                    <!-- Product reviews-->
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="cuartacompra.html"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Suéter Casual de Los Hombres Suéter de algodón'; // Reemplaza con la información del producto
