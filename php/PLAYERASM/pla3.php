...
<html lang="en">
    <head>
        ...
        <title>  Playera corta color verde con cuello</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/3b/af/9c/3baf9c828325338bd837c23fd2248356.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera corta color verde con cuello</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 249</span>
                        </div>
                        <p class="lead">Una prenda de vestir informal que combina dos tonos: verde y blanco. La parte principal de la playera, es un cuello color blanco y un estampado de rana coqueto.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Playera corta color verde con cuello'; // Reemplaza con la información del producto
