...
<html lang="en">
    <head>
        ...
        <title>  Top blanco con mangas</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/564x/e5/ce/d7/e5ced7a2b9ba790f60fa832a444f309f.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top blanco con mangas</h1>
                        <div class="fs-5 mb-5">
