...
<html lang="en">
    <head>
        ...
        <title>  Top café con tirantes</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/e6/1c/26/e61c260cbff2632e413423e396ab94ee.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top café con tirantes</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 299</span>
                            <span>MXN 149</span>
                        </div>
                        <p class="lead"> Top sencillo color café con tirantes delgados y un pequeño estampado de corazón. </p>
                        <div class="d-flex"> 
