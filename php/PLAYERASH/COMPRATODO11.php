...
<html lang="en">
    <head>
        ...
        <title>      Playera  banda de México   </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://suavecito.com.mx/cdn/shop/products/Suavecito_Mexican_Flag_OG_Tee_Front_2048x_395529be-b8a8-4bd3-83eb-3ffaed34850d.jpg?v=1598484328" alt="..." /></div>
                    <div class="col-md-6">

                        <h1 class="display-5 fw-bolder">     Playera hombre OG banda de México    </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 329 </span>
                        </div>
                        <p class="lead">
                            ¡Celebra el legado musical con nuestra exclusiva playera "OG Banda de México" para hombre! Esta prenda rinde homenaje a la rica tradición de la música de banda, fusionando estilo y orgullo por la herencia musical mexicana.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Playera hombre OG banda de México   '; // Reemplaza con la información del producto
                var precio = 329; // Reemplaza con el precio del producto
