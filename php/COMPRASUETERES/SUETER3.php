...
<html lang="en">
    <head>
        ...
        <title> Chaqueta De Suéter De Lana Con Cremallera   </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.linio.com/p/796cd81f63d560e44de73a438e21f321-product.jpg" alt="..." /></div>
                    <div class="col-md-6">
                      
                        <h1 class="display-5 fw-bolder">  Chaqueta De Suéter De Lana Con Cremallera Delgada Para Suéter Hombre </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 799</span>
                        </div>
                        <p class="lead">
                            ¡Explora la combinación perfecta de estilo y confort con nuestra Chaqueta de Suéter de Lana con Cremallera Delgada para Hombres! Esta prenda es una opción elegante y funcional para mantenerte abrigado con un toque moderno durante las estaciones más frescas. </p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://cdn-images.farfetch-contents.com/21/50/74/57/21507457_51537086_300.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"> Suéteres de diseñador - Moda para hombre </h5>
                                    <!-- Product price-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="SUETER5.PHP">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Chaqueta De Suéter De Lana Con Cremallera '; // Reemplaza con la información del producto
                var precio = 799; // Reemplaza con el precio del producto
