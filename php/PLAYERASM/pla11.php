...
<html lang="en">
    <head>
        ...
        <title>  Playera negra con mangas transparentes</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/26/d9/5b/26d95b6b68decb64a044a551b0b29bf3.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera negra con mangas transparentes</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 349</span>
                        </div>
                        <p class="lead">Camisa negra con estampado en letras cursivas y mangas largas transparentes.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera negra con mangas transparentes'; // Reemplaza con la información del producto
