...
<html lang="en">
    <head>
        ...
        <title>  Playera tipo top con manga larga</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/fd/52/be/fd52bee6d11928ad1d436042bf426097.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera tipo top con manga larga</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 499</span>
                            <span>MXN 399</span>
                        </div>
                        <p class="lead">Camisa negra de manga larga en blanco y negro con lineas.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Playera tipo top con manga larga'; // Reemplaza con la información del producto
