...
<html lang="en">
    <head>
        ...
        <title>  Top negro con tirantes de cadenas</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/dc/e9/98/dce99870f69a9acfdb267ff45375061b.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top negro con tirantes de cadenas</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 499</span>
                            <span>MXN 399</span>
                        </div>
                        <p class="lead"> Top negro cadenas como tirantes y un estampado en color blanco.</p>
                        <div class="d-flex"> 
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="top1.html">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
