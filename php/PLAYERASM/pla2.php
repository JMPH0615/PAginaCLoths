...
<html lang="en">
    <head>
        ...
        <title>  Playera corta color blanco con negro</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/ee/e4/ce/eee4ce22ba99c66944e057dca73ed8ef.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera corta color blanco con negro</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 249</span>
                            <span>MXN 199</span>
                        </div>
                        <p class="lead">Una prenda de vestir informal que combina dos tonos: negro y blanco. La parte principal de la playera, tiene un estampado de estrella y negro en las mangas cortas </p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"> Playera corta color café con blanco </h5>
                                    <!-- Product reviews-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="pla1.php">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="pla6.php"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                </div>
