...
<html lang="en">
    <head>
        ...
        <title>     Playera tirando rostro   </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://tirandorostro.com.mx/cdn/shop/collections/MOCKUP_PLAYERA_BLANCA_COLECCION_TR_FLAG_CABALLERO_590x.jpg?v=1651636410" alt="..." /></div>
                    <div class="col-md-6">
                      
                        <h1 class="display-5 fw-bolder">    Playera tirando rostro    </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 399 </span>
                        </div>
                        <p class="lead">
                            Si por "tirando rostro" te refieres a una playera con un diseño o estampado de una cara haciendo una expresión graciosa o peculiar, ¡has llegado al lugar indicado para la creatividad! Imagina una playera con una cara que refleje humor, sorpresa o cualquier otra emoción divertida.</p>
                        <div class="d-flex"> 
