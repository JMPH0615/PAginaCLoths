...
<html lang="en">
    <head>
        ...
        <title>  Playera con estampado de corazón</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/564x/86/6d/3e/866d3e2559b2d3f3f9c93ec19c839b3f.jpg"..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera con estampado de corazón</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 249</span>
                        </div>
                        <p class="lead">Una playera blanca con estampado de corazón color negro.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = 'Playera con estampado de corazón'; // Reemplaza con la información del producto
