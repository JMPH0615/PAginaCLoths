...
<html lang="en">
    <head>
        ...
        <title>  Top manga larga color morado</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/db/fb/e2/dbfbe2b88d00527609d04b21cd0b4826.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top manga larga color morado</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 299</span>
                        </div>
                        <p class="lead"> Top manga larga color lila y escote recto. </p>
                        <div class="d-flex"> 
