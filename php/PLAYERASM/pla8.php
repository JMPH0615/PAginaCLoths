...
<html lang="en">
    <head>
        ...
        <title>  Playera corta con estampado de panda</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/6e/b9/c0/6eb9c0ac29e60bdfe1b0a693ad03aa74.jpg"..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera corta con estampado de panda</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 249</span>
                        </div>
                        <p class="lead">Playera de manga corta color blanco con estampado negro de panda.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera corta con estampado de panda'; // Reemplaza con la información del producto
