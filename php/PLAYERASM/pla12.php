...
<html lang="en">
    <head>
        ...
        <title>  Playera negra de Tokyo Revengers</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/564x/9f/ee/b3/9feeb3b84f8c59d9065ccbbde8596193.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera negra de Tokyo Revengers</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 799</span>
                            <span>MXN 599</span>
                        </div>
                        <p class="lead">Playera negra con estampado color blanco de Tokyo Revengers.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera negra de Tokyo Revengers'; // Reemplaza con la información del producto
                var precio = 599; // Reemplaza con el precio del producto
