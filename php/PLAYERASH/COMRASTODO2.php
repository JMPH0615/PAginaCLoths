...
<html lang="en">
    <head>
        ...
        <title>   Playera Cuello Redondo </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://nao.com.mx/cdn/shop/products/PlayeraHombre.CuelloRedondo.Espalda.Purpura..jpg?v=1606171510" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Playera Cuello Redondo Peso Completo </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 249</span>
                        </div>
                        <p class="lead">
                            ¡Descubre la comodidad definitiva con nuestra increíble playera de cuello redondo de peso completo! Esta prenda no solo es una elección de estilo versátil, sino que también ofrece la máxima suavidad y durabilidad para acompañarte en todas tus aventuras diarias.</p>
                        <div class="d-flex"> 
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera Cuello Redondo Peso Completo'; // Reemplaza con la información del producto
                var precio = 249; // Reemplaza con el precio del producto
