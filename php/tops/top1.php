...
<html lang="en">
    <head>
        ...
        <title>  Top color negro con blanco y mariposas</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/a4/2f/b9/a42fb9daa7f893e691b7ad71955d19d8.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top color negro con blanco y mariposas</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 249</span>
                        </div>
                        <p class="lead"> Top negro con blanco con mariposas estampadas, con un diseño moderno y chic.</p>
                        <div class="d-flex"> 
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="top2.html">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://i.pinimg.com/236x/8a/81/c0/8a81c030d6139733c09e95297a5a9a02.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Top sin mangas de colores azul a cuadros</h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="top3.html"> VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="top4.html"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="top5.html"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                </div>
