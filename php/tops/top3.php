...
<html lang="en">
    <head>
        ...
        <title>  Top sin mangas de colores azul a cuadros</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/8a/81/c0/8a81c030d6139733c09e95297a5a9a02.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top sin mangas de colores azul a cuadros</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 349</span>
                            <span>MXN 249</span>
                        </div>
                        <p class="lead"> Top en tonos azules a cuadros y tirantes delgados. </p>
                        <div class="d-flex"> 
