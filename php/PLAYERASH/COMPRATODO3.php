...
<html lang="en">
    <head>
        ...
        <title>   Playera hombre negra  </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://oranch.com.mx/wp-content/uploads/2021/06/sublimados_0028_Captura-de-Pantalla-2021-06-08-a-las-13.34.08.jpg" alt="..." /></div>
                    <div class="col-md-6">
                      
                        <h1 class="display-5 fw-bolder">  Playera hombre negra </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 269</span>
                        </div>
                        <p class="lead">
                            Sumérgete en el estilo atemporal con nuestra playera negra para hombre, una prenda esencial que destaca por su elegancia y versatilidad.

Confeccionada en algodón de alta calidad, esta playera garantiza suavidad y comodidad durante todo el día. El color negro ofrece un toque de sofisticación y se adapta fácilmente a cualquier ocasión, desde encuentros casuales hasta eventos más formales.</p>
                        <div class="d-flex"> 
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">  Playera hombre blanca </h5>
                                    <!-- Product price-->
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera hombre negra '; // Reemplaza con la información del producto
                var precio = 269; // Reemplaza con el precio del producto
