...
<div id="contenedorBotones" class="mt-3">
    <!-- Aquí se agregarán dinámicamente los botones de agregar al carrito -->
</div>
    ...
    <div id="carritoPopoverContent" class="d-none">
        ...
        <div class="text-center mt-3">
            <a href="CARRITOTODO.php" class="btn btn-success" id="pagarBtn">Pagar</a>
        </div>
    </div>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i5.walmartimages.com.mx/mg/gm/3pp/asr/e257b4e1-0f7c-4ba2-ad52-45ce9975740e.893e191d742df55b2c27e1350e4ef65a.jpeg" alt="..." /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">(CODIGO DE LA CAMISA)</div>
                        <h1 class="display-5 fw-bolder">Camisa azul manga larga</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 599</span>
                            <span>MXN 499</span>
                        </div>
                        <p class="lead">Azul Clásico es tu destino para encontrar la combinación perfecta de estilo y sofisticación en camisas para caballero. Nuestra exclusiva colección de camisas azules de manga larga destaca por su diseño atemporal y versatilidad. Confeccionadas con los mejores tejidos para garantizar comodidad y durabilidad, nuestras camisas son ideales para ocasiones formales y eventos sociales.</p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://brooksbrothers.vteximg.com.br/arquivos/ids/223352-520-631/100197251_1.jpg?v=638252380157870000" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">Pantalón azul marino</h5>
                                    <!-- Product price-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="segundacompra.php">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://cdn1.coppel.com/images/catalog/pr/8128062-1.jpg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"> Tenis Polo</h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="terceracompra.php"> VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://trueshop.mx/cdn/shop/files/top_manga_larga_rib_H.E.R_negra_1_tops_bodies_720x720.jpg?v=1699540063" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"> Top negro</h5>
                                    <!-- Product price-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="quintacompra.php"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://static.bershka.net/4/photos2/2023/I/0/1/p/5764/187/800/057f58b01ec149dd45a344e8d3e94cf5-5764187800_1_3_0.jpg?imwidth=750&impolicy=bershka-itxmediumhigh&imformat=chrome" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"> Vestido mujer</h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="cuartacompra.php"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Camisa Azul Hombre   '; // Reemplaza con la información del producto
                var precio = 499; // Reemplaza con el precio del producto
