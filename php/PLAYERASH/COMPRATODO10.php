...
<html lang="en">
    <head>
        ...
        <title>     Playera hombre Kawai   </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.etsystatic.com/31591741/r/il/aece3a/3565054567/il_1080xN.3565054567_5cvy.jpg" alt="..." /></div>
                    <div class="col-md-6">
                     
                        <h1 class="display-5 fw-bolder">    Playera hombre Kawai    </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 399 </span>
                        </div>
                        <p class="lead">
                            ¡Embárcate en un viaje lleno de ternura y estilo con nuestra adorable playera para hombre de estilo "kawaii"! Esta prenda no solo es una expresión de la estética kawaii, sino que también te permite llevar la dulzura y la diversión a tu vestuario diario.</p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://milano.com/cdn/shop/products/661-9025A_Playera_Basica_Lisa_Manga_Corta_Cuello_Redondo_Caballero_Milano_Tallas-Extras_e_250x.jpg?v=1664405148" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">   Playera hombre roja </h5>
                                    <!-- Product price-->
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRASTODO7.php">VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera hombre Kawai  '; // Reemplaza con la información del producto
                var precio = 399; // Reemplaza con el precio del producto
