...
<html lang="en">
    <head>
        ...
        <title>   Playera Feliz Navidad  </title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://plash.mx/cdn/shop/products/Feliz_Navidad_Playera_para_Caballero.jpg?v=1590858745" alt="..." /></div>
                    <div class="col-md-6">
                      
                        <h1 class="display-5 fw-bolder">  Playera Caballero Feliz Navidad   </h1>
                        <div class="fs-5 mb-5">
                            
                            <span>MXN 259</span>
                        </div>
                        <p class="lead">
                            Confeccionada en algodón suave y cómodo, esta playera es perfecta para llevar durante las celebraciones navideñas. Su diseño festivo presenta un mensaje alegre de "Feliz Navidad" impreso de manera llamativa, acompañado de elementos navideños como renos, copos de nieve o adornos, que añaden un toque festivo y divertido.</p>
                        <div class="d-flex"> 
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <!-- Product image-->
                            <img class="card-img-top" src="https://tirandorostro.com.mx/cdn/shop/collections/MOCKUP_PLAYERA_BLANCA_COLECCION_TR_FLAG_CABALLERO_590x.jpg?v=1651636410" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">   Playera tirando rostro   </h5>
                                    <!-- Product reviews-->
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRATODO8.php"> VER DETALLES</a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col mb-5">
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="https://www.innovasport.com/medias/playera-under-armour-project-rock-is-1351582-001-1.png?context=bWFzdGVyfGltYWdlc3w1OTg4N3xpbWFnZS9wbmd8aW1hZ2VzL2hiOC9oNDAvOTkxMDUxMjI4Nzc3NC5wbmd8NWIzNWJhOGUxYTdjMTU5OTgwNzFlM2M1YWExNTdkOGRkM2Y0NGJkYTMxZGRjYjJkNDNhYWMwNzk3NDI1MGFjMg" alt="..." />
                            <!-- Product details-->
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">   Playera Under Armour Project Rock </h5>
                                    <!-- Product reviews-->
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"></div>
                                        <div class="bi-star-fill"></div>
                            ...
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="COMPRASTODO12.php"> VER DETALLES </a></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.agregar-carrito-btn').click(function () {
                ...
                var producto = ' Playera Caballero Feliz Navidad  '; // Reemplaza con la información del producto
                var precio = 259; // Reemplaza con el precio del producto
