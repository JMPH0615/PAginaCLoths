...
<html lang="en">
    <head>
        ...
        <title>  Top blanco con tirantes</title>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://i.pinimg.com/236x/4c/6a/d8/4c6ad87aed315f162e3b6d1c9807cac6.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Top blanco con tirantes</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 399</span>
                            <span>MXN 289</span>
                        </div>
                        <p class="lead"> Top blanco con escode en nudo y tirantes delgados. </p>
                        <div class="d-flex"> 
