        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="https://m.media-amazon.com/images/I/618KleSGkUL.jpg" alt="..." /></div>
                    <div class="col-md-6">
                        
                        <h1 class="display-5 fw-bolder">  Suéter Casual de Los Hombres Suéter de algodón de manga larga de otoño e invierno for hombre</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">MXN 599</span>
                            <span>MXN 499</span>
                        </div>
                        <p class="lead">Fabricado con algodón premium, este suéter ofrece una sensación suave y acogedora contra tu piel. La calidad del material garantiza durabilidad y resistencia, proporcionándote una prenda que perdura en el tiempo.</p>
                        <div class="d-flex"> 
